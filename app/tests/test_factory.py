...
# def test_piastrix_invoice(client):
#     data = {'amount': 150, 'currency': '643', 'description': 'test payment', 'shop_id': 5}
#     response = client.post('/', data=data)
#     del data['shop_id']
#     data['shop_order_id'] = '195'
...
def test_piastrixs_sing(client):
